...
REM   HEDIT-CR.COM - Cromemco 3102 (mono only)
REM
...
if exist HEDIT-CR.COM del HEDIT-CR.COM 2>nul
...
for %%M in (HEDIT HEXKEY HEXGAP HEXIO HEXMENU HEXMNVT HEXSRCH HEXBLK HEXKBND HEXVIRT HEXHELP HEVT52 HEADM31 HEADM31K HEC3102 HEC3102K) do (
    cpmulator M80.COM =%%M
    echo %%M
	pause
    if errorlevel 1 goto fail
...
echo.
echo --- Variant 1/5: HEDIT.COM (VT100 mono) ---
python HEBUILD.PY 0
if errorlevel 1 goto fail
...
echo.
echo --- Variant 2/5: HEDIT-CL.COM (VT100 color) ---
python HEBUILD.PY 1
if errorlevel 1 goto fail
python CPMFMT.PY HECONFIG.INC
if errorlevel 1 goto fail
...
echo.
echo --- Variant 3/5: HEDIT-52.COM (VT52) ---
...
echo.
echo --- Variant 4/5: HEDIT-AD.COM (ADM-31) ---
...
echo.
echo --- Variant 5/5: HEDIT-CR.COM (Cromemco 3102) ---
REM Cromemco 3102 uses HEC3102 for screen, HEC3102K for keys,
REM HEXMNVT for menu. Always mono.
cpmulator L80.COM HEDIT,HEC3102,HEC3102K,HEXGAP,HEXIO,HEXMNVT,HEXSRCH,HEXBLK,HEXKBND,HEXVIRT,HEXHELP,HEDIT/N/E
if errorlevel 1 goto fail
copy /y HEDIT.COM HEDIT-CR.COM >nul
echo Built HEDIT-CR.COM (Cromemco 3102)
...
echo   HEDIT-CR.COM - Cromemco 3102
goto end
